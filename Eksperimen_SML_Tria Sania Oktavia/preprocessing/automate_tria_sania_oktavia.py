...
def run_preprocessing():
    ...
    train_data.to_csv('preprocessing/namadataset_preprocessing/train_processed.csv', index=False)
    test_data.to_csv('preprocessing/namadataset_preprocessing/test_processed.csv', index=False)
